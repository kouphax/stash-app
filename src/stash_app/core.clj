...
(def github-client-id (get (System/getenv) "GITHUB_CLIENT_ID"))
(def github-client-secret (get (System/getenv) "GITHUB_CLIENT_SECRET"))
...
(defn make-github-authorizeurl
  ...
  []
  (str github-authorize-url (format "?client_id=%s&redirect_url=%s&state=token&scope=public_repo"
